...
def submit_job(time, memory, nthreads, jobname, script, script_args):
...
def main(process_id, time, memory, threadmem, nthreads, inputthreads, jobname, script, args):
    ...
    job_id = submit_job(time, memory, nthreads, jobname, script, args)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--time', required=True, help='Time limit for job')
    ...
    main(args.pid, args.time, args.mem, args.thread_mem, args.threads, args.inputthreads, args.jobname, args.script, args.job_args)
